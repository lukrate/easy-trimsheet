...
class PanZoomCanvas(tk.Frame):
    ...
    def create_widget(self,width,height):
        # Canvas
        self.canvas = tk.Canvas(self.master, background="red", width = width,height = height)
        self.canvas.grid(rowspan=3)
...
if __name__ == "__main__":
    ...
    app = PanZoomCanvas(master=root,canvas_w = 600,canvas_h = 600)
    app.canvas.config(bg = 'grey')
    app.set_image(os.path.join(os.getcwd(), 'images', 'photo_2023-04-23_16-26-56.jpg'))
    app.mainloop()
