...
class Exportzone(ctk.CTkFrame):
    def __init__(self, master, layers, **kwargs):
        ...
        self.export_name_frame.grid(column=2, row=1, padx=15, pady=15, sticky="nsew")
        ...
        self.export_folder_frame.grid(column=2, row=2, padx=15, pady=15, sticky="nsew")
        ...
        self.file_format_frame.grid(column=3, row=1, rowspan=2, padx=15, pady=15, sticky="nsew")
